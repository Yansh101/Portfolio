...
import "./Profile.css";
import PriyanshuCV from "./Priyanshu-Joshi CV.pdf";
    ...
    <div id="profile" className="profile">
      ...
      <div className="section__text profile-info">
        ...
        <div className="btn-container">
          <a href={PriyanshuCV} download className="btn btn-color-2 btncv">
            Download CV
          </a>
          <a href="#contact" className="btn btn-color-1 btncv">
            Contact Info
          </a>
        </div>
